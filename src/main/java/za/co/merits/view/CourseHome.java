...
public class CourseHome implements Serializable {
	...
	public Course getCourse() {
		...
		if (course == null) {
			...
			course = meritsFacade.getCourse(id);
		}
	...
	public List<Student> getStudents() {
		if (students == null) {
			students = meritsFacade.getStudentsForCourse(getCourse());
		}
		return students;
	}
	...
	public void setTeacherId(Long teacherId) {
		if (teacherId != null && teacherId != null) {
			if (!teacherId.equals(getTeacherId())) {
				getCourse().setTeacher(meritsFacade.getTeacher(teacherId));
			}
		} else {
